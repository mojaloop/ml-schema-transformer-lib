 ...
 describe('FSPIOPISO20022TransformFacade tests', () => {
   ...
   describe('Parties', () => {
     test('should transform PUT parties payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.parties.put, FspiopIso20022TransformFacade.parties.put, null)();
     });
     test('should transform PUT parties error payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.parties.putError, FspiopIso20022TransformFacade.parties.putError, null)();
     });
   })
   describe('Quotes', () => {
     test('should transform POST quotes payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.quotes.post, FspiopIso20022TransformFacade.quotes.post, null)();
     });
     test('should transform PUT quotes payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.quotes.put, FspiopIso20022TransformFacade.quotes.put, null)();
     });
     test('should transform PUT quotes error payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.quotes.putError, FspiopIso20022TransformFacade.quotes.putError, null)();
     });
   })
   describe('FXQuotes', () => {
     test('should transform POST FX quotes payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxQuotes.post, FspiopIso20022TransformFacade.fxQuotes.post, null)();
     })
     test('should transform PUT FX quotes payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxQuotes.put, FspiopIso20022TransformFacade.fxQuotes.put, null)();
     })
     test('should transform PUT FX quotes error payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxQuotes.putError, FspiopIso20022TransformFacade.fxQuotes.putError, null)();
     })
   })
   describe('Transfers', () => {
     test('should transform POST transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.transfers.post, FspiopIso20022TransformFacade.transfers.post, null)();
     })
     test('should transform PATCH transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.transfers.patch, FspiopIso20022TransformFacade.transfers.patch, null)();
     })
     test('should transform PUT transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.transfers.put, FspiopIso20022TransformFacade.transfers.put, null)();
     })
     test('should transform PUT transfers error payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.transfers.putError, FspiopIso20022TransformFacade.transfers.putError, null)();
     })
   })
   describe('FXTransfers', () => {
     test('should transform POST FX transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxTransfers.post, FspiopIso20022TransformFacade.fxTransfers.post, null)();
     })
     test('should transform PATCH FX transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxTransfers.patch, FspiopIso20022TransformFacade.fxTransfers.patch, null)();
     })
     test('should transform PUT FX transfers payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxTransfers.put, FspiopIso20022TransformFacade.fxTransfers.put, null)();
     })
     test('should transform PUT FX transfers error payload from FSPIOP ISO 20022 to FSPIOP', async () => {
       await testCase(fspiop_iso20022.fxTransfers.putError, FspiopIso20022TransformFacade.fxTransfers.putError, null)();
     })
   })
 });
