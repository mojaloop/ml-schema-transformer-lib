...
export const quotes = {
  post: `{
    ...
    "body.payee.personalInfo.complexName.middleName": ["body.CdtTrfTxInf.Cdtr.Name", { "$transform": "getSecondFromDelimitedName" }],
    "body.payee.personalInfo.complexName.lastName": ["body.CdtTrfTxInf.Cdtr.Name", { "$transform": "getThirdFromDelimitedName" }],
    ...
    "body.payer.personalInfo.complexName.middleName": ["body.CdtTrfTxInf.Dbtr.Name", { "$transform": "getSecondFromDelimitedName" }],
    "body.payer.personalInfo.complexName.lastName": ["body.CdtTrfTxInf.Dbtr.Name", { "$transform": "getThirdFromDelimitedName" }],
