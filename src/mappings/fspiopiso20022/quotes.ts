...
export const quotes = {
  post: `{
    ...
    "body.payee.name": ["body.CdtTrfTxInf.Cdtr.Nm", { "$transform": "getDisplayNameFromDelimitedName" }],
    "body.payee.personalInfo.complexName.firstName": ["body.CdtTrfTxInf.Cdtr.Nm", { "$transform": "getFirstFromDelimitedName" }],
    "body.payee.personalInfo.complexName.middleName": ["body.CdtTrfTxInf.Cdtr.Nm", { "$transform": "getMiddleFromDelimitedName" }],
    "body.payee.personalInfo.complexName.lastName": ["body.CdtTrfTxInf.Cdtr.Nm", { "$transform": "getLastFromDelimitedName" }],
    ...
    "body.payer.name": ["body.CdtTrfTxInf.Dbtr.Nm", { "$transform": "getDisplayNameFromDelimitedName" }],
    "body.payer.personalInfo.complexName.firstName": ["body.CdtTrfTxInf.Dbtr.Nm", { "$transform": "getFirstFromDelimitedName" }],
    "body.payer.personalInfo.complexName.middleName": ["body.CdtTrfTxInf.Dbtr.Nm", { "$transform": "getMiddleFromDelimitedName" }],
    "body.payer.personalInfo.complexName.lastName": ["body.CdtTrfTxInf.Dbtr.Nm", { "$transform": "getLastFromDelimitedName" }],
...
export const quotes_reverse = {
  post: `{
    ...
    "body.CdtTrfTxInf.Cdtr.Nm": ["body.payee", { "$transform": "makeDelimitedName" }],
    ...
    "body.CdtTrfTxInf.Dbtr.Nm": ["body.payer", { "$transform": "makeDelimitedName" }],
