...
export const quotes = {
  post: `{
    ...
    "body.payee.partyIdInfo.partySubIdOrType": { "$alt": [ "body.CdtTrfTxInf.Cdtr.Id.OrgId.Othr.Issr", "body.CdtTrfTxInf.Cdtr.Id.PrvtId.Othr.Issr" ] },
    ...
    "body.payer.partyIdInfo.partySubIdOrType": { "$alt": [ "body.CdtTrfTxInf.Dbtr.Id.OrgId.Othr.Issr", "body.CdtTrfTxInf.Dbtr.Id.PrvtId.Othr.Issr" ] },
...
export const quotes_reverse = {
  post: `{
    ...
    "body.CdtTrfTxInf.Cdtr.Id.OrgId.Othr.Issr": ["body.payee.partyIdInfo.partySubIdOrType", { "$filter": "isNotPersonParty" }],
    "body.CdtTrfTxInf.Cdtr.Id.PrvtId.Othr.Id": ["body.payee.partyIdInfo.partyIdentifier", { "$filter": "isPersonParty" }],
    "body.CdtTrfTxInf.Cdtr.Id.PrvtId.Othr.Issr": ["body.payee.partyIdInfo.partySubIdOrType", { "$filter": "isPersonParty" }],
    ...
    "body.CdtTrfTxInf.Dbtr.Id.OrgId.Othr.Issr": ["body.payer.partyIdInfo.partySubIdOrType", { "$filter": "isNotPersonParty" }],
    "body.CdtTrfTxInf.Dbtr.Id.PrvtId.Othr.Id": ["body.payer.partyIdInfo.partyIdentifier", { "$filter": "isPersonParty" }],
    "body.CdtTrfTxInf.Dbtr.Id.PrvtId.Othr.Issr": ["body.payer.partyIdInfo.partySubIdOrType", { "$filter": "isPersonParty" }],
  ...
  putTesting: `{
    ...
    "body.CdtTrfTxInf.Dbtr.Id.OrgId.Othr.Issr": "$context.isoPostQuote.CdtTrfTxInf.Dbtr.Id.OrgId.Othr.Issr",
    ...
    "body.CdtTrfTxInf.Cdtr.Id.OrgId.Othr.Issr": "$context.isoPostQuote.CdtTrfTxInf.Cdtr.Id.OrgId.Othr.Issr",
