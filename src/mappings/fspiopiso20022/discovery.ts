...
export const discovery = {
  parties: {
    put: `{
      ...
      "body.party.name": ["body.Rpt.UpdtdPtyAndAcctId.Pty.Nm", { "$transform": "getDisplayNameFromDelimitedName" }],
...
export const discovery_reverse = {
  parties: {
    put: `{
      ...
      "body.Rpt.UpdtdPtyAndAcctId.Pty.Nm": ["body.party", { "$transform": "makeDelimitedName" }],
