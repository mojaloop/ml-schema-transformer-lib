...
import { fxTransfers_reverse } from 'src/mappings/fspiopiso20022';

const { discovery_reverse, quotes_reverse, transfers_reverse, fxQuotes_reverse, fxQuotes, transfers, fxTransfers } = FSPIO20022PMappings;
